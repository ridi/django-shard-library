...
from shard.utils.database import get_shard_groups, get_master_databases_by_shard_group
...
class PoolProvider:
    ...
    def create(self):
        ...
        for shard_group in shard_groups:
            ...
            self._pools[shard_group] = ConHashPool(nodes=databases, replica=get_replica_count(shard_group=shard_group))
