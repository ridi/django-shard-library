...
from shard.utils.database import get_shard_groups, get_master_databases_by_shard_group, get_database_names
...
class PoolProvider:
    ...
    def create(self):
        ...
        for shard_group in shard_groups:
            ...
            database_names = get_database_names(databases)
            self._pools[shard_group] = ConHashPool(nodes=database_names, replica=get_replica_count(shard_group=shard_group))
